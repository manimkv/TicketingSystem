...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ticket', fields ['subject']
        db.create_unique(u'ticket_ticket', ['subject'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['subject']
        db.delete_unique(u'ticket_ticket', ['subject'])
